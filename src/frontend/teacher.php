...
<body>
    ...
    <div class="main">
       ...
       <div> <a href="./addteacher.php" style="color:white;">add</a></div>
    ...
    if(mysqli_num_rows($result) > 0){
         while($row = mysqli_fetch_assoc($result)){
           ...
           echo "<tr>
             ...
             <td> <a href='../backend/delete.php?sid=$row[id]' style='color:white;'> delete</a> 
             <a href='./update.php?sid=$row[id]' style='color:white;'> update</a>            
             </td>
